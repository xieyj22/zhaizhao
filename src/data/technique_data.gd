...
const _SIGNATURE := [
	...
	{"id":&"jingzhao_yingzhao", "name":"镜照·映照", "type":"STANCE_SWITCH", "range":0, "dmg":0, "spd":6, "op":0, "stance":Stance.Id.EARTH, "fac":"F1", "tier":2},
	{"id":&"chifeng_lianci", "name":"赤锋·连刺", "type":"STRIKE", "range":0, "dmg":6, "spd":6, "op":1, "stance":Stance.Id.METAL, "fac":"F2", "tier":2},
	{"id":&"chifeng_yajin", "name":"赤锋·压阵", "type":"MOVE", "range":0, "dmg":0, "spd":6, "op":0, "stance":-1, "fac":"F2", "tier":2},
	{"id":&"pangen_lagen", "name":"盘根·老树", "type":"STANCE_SWITCH", "range":0, "dmg":0, "spd":6, "op":0, "stance":Stance.Id.WOOD, "fac":"F3", "tier":2},
	...
	{"id":&"tingchao_xieli", "name":"听潮·卸力", "type":"MOVE", "range":0, "dmg":0, "spd":6, "op":0, "stance":-1, "fac":"F4", "tier":2},
	{"id":&"lieyan_liaoyuan", "name":"烈焰·燎原", "type":"STRIKE", "range":1, "dmg":7, "spd":5, "op":1, "stance":Stance.Id.FIRE, "fac":"F5", "tier":2},
	{"id":&"lieyan_pokong", "name":"烈焰·破空", "type":"STRIKE", "range":2, "dmg":4, "spd":5, "op":1, "stance":Stance.Id.FIRE, "fac":"F5", "tier":2},
	{"id":&"huazong_zhuangtu", "name":"幻踪·装土", "type":"FEINT", "range":1, "dmg":4, "spd":5, "op":1, "stance":Stance.Id.EARTH, "fac":"F6", "tier":2},
	{"id":&"huazong_zhuanghuo", "name":"幻踪·装火", "type":"FEINT", "range":1, "dmg":4, "spd":5, "op":1, "stance":Stance.Id.FIRE, "fac":"F6", "tier":2},
	{"id":&"yexiao_tujin", "name":"夜枭·突进", "type":"MOVE", "range":0, "dmg":0, "spd":7, "op":0, "stance":-1, "fac":"F7", "tier":2},
	{"id":&"yexiao_liuzhuan", "name":"夜枭·流转", "type":"STANCE_SWITCH", "range":0, "dmg":0, "spd":7, "op":0, "stance":Stance.Id.EARTH, "fac":"F7", "tier":2},
	{"id":&"xueyi_xuedao", "name":"血衣·血祭", "type":"STRIKE", "range":0, "dmg":7, "spd":6, "op":1, "stance":Stance.Id.METAL, "fac":"F8", "tier":3},
	{"id":&"xueyi_zhuangjin", "name":"血衣·装金", "type":"FEINT", "range":1, "dmg":4, "spd":5, "op":1, "stance":Stance.Id.METAL, "fac":"F8", "tier":3},
]
const _HIDDEN := [
